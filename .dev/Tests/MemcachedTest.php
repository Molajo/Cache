...
use Molajo\Cache\Handler\Memcached as MemcachedCache;
...
class MemcachedTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $adapter_handler = new MemcachedCache();

        $this->options                  = array();
        $this->options['cache_service'] = true;
        $this->options['cache_time']    = 600; //ten minutes
//        $this->options['memcached_pool']    = 600; //ten minutes
        $this->options['memcached_compression']    = true; //ten minutes
  //      $this->options['memcached_servers']    = 600; //ten minutes
     ...
     *
     * @covers  Molajo\Cache\Handler\Memcached::get
     * @covers  Molajo\Cache\Handler\Memcached::set
     *
     * @return  $this
     * @since   1.0
     */
